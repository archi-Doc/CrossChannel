...
/// </summary>
public static class ObsoleteRadio // CrossChannel by Romeo
{
    /// <summary>
    ...
    /// <returns>A new instance of XChannel.<br/>
    /// You need to call <see cref="XChannel.Dispose()"/> when the channel is no longer necessary, unless the weak reference is specified.</returns>
    public static XChannel OpenAsync<TMessage>(Func<TMessage, Task> method, object? weakReference = null) => ObsoleteRadio.OpenTwoWay<TMessage, Task>(method, weakReference);
    ...
    public static XChannel OpenAsyncKey<TKey, TMessage>(TKey key, Func<TMessage, Task> method, object? weakReference = null)
        where TKey : notnull => ObsoleteRadio.OpenTwoWayKey<TKey, TMessage, Task>(key, method, weakReference);
    ...
    /// <returns>A new instance of XChannel.<br/>
    /// You need to call <see cref="XChannel.Dispose()"/> when the channel is no longer necessary, unless the weak reference is specified.</returns>
    public static XChannel OpenTwoWayAsync<TMessage, TResult>(Func<TMessage, Task<TResult>> method, object? weakReference = null) => ObsoleteRadio.OpenTwoWay<TMessage, Task<TResult>>(method, weakReference);
    ...
    public static XChannel OpenTwoWayAsyncKey<TKey, TMessage, TResult>(TKey key, Func<TMessage, Task<TResult>> method, object? weakReference = null)
         where TKey : notnull => ObsoleteRadio.OpenTwoWayKey<TKey, TMessage, Task<TResult>>(key, method, weakReference);
